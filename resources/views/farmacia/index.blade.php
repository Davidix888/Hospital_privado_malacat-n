    ...
    <section style="padding-top: 1.25rem;">
        ...
        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4" style="margin-top: 1.50rem; margin-bottom: 1.50rem;">
            <article class="flex min-h-[260px] flex-col border border-[#0b1b57]/10 bg-white p-6 shadow-sm sm:p-8">
                <div class="space-y-3">
                    <p class="text-sm font-semibold uppercase tracking-[0.2em] text-[#d71920]">M&oacute;dulo operativo</p>
            ...
            <article class="flex min-h-[260px] flex-col border border-[#0b1b57]/10 bg-white p-6 shadow-sm sm:p-8">
                <div class="space-y-3">
                    <p class="text-sm font-semibold uppercase tracking-[0.2em] text-[#d71920]">M&oacute;dulo anal&iacute;tico</p>
