        ...
        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3" style="margin-top: 1.50rem; margin-bottom: 1.50rem;">
            <article class="flex min-h-[260px] flex-col border border-[#0b1b57]/10 bg-white p-6 shadow-sm sm:p-8">
                <div class="space-y-3">
                    ...
                    <h2 class="font-['Outfit'] text-3xl font-semibold text-[#0b1b57]">Registrar usuario</h2>
            ...
            <article class="flex min-h-[260px] flex-col border border-[#0b1b57]/10 bg-white p-6 shadow-sm sm:p-8">
                <div class="space-y-3">
                    ...
                    <h2 class="font-['Outfit'] text-3xl font-semibold text-[#0b1b57]">Editar usuarios</h2>
                    <p class="max-w-2xl text-sm leading-7 text-[#0b1b57]/70 sm:text-base">
            ...
            <article class="flex min-h-[260px] flex-col border border-[#0b1b57]/10 bg-white p-6 shadow-sm sm:p-8">
                <div class="space-y-3">
                    ...
                    <h2 class="font-['Outfit'] text-3xl font-semibold text-[#0b1b57]">Usuarios registrados</h2>
                    <p class="max-w-2xl text-sm leading-7 text-[#0b1b57]/70 sm:text-base">
            ...
            <article class="flex min-h-[260px] flex-col border border-[#0b1b57]/10 bg-white p-6 shadow-sm sm:p-8">
                <div class="space-y-3">
                    ...
                    <h2 class="font-['Outfit'] text-3xl font-semibold text-[#0b1b57]">Activar y desactivar</h2>
                    <p class="max-w-2xl text-sm leading-7 text-[#0b1b57]/70 sm:text-base">
